...
ActivityCondition.create(activity_id: 3, condition_id: 1)
ActivityCondition.create(activity_id: 3, condition_id: 2)
ActivityCondition.create(activity_id: 3, condition_id: 3)
ActivityCondition.create(activity_id: 3, condition_id: 4)
ActivityCondition.create(activity_id: 3, condition_id: 5)
ActivityCondition.create(activity_id: 3, condition_id: 6)
ActivityCondition.create(activity_id: 3, condition_id: 7)
ActivityCondition.create(activity_id: 4, condition_id: 1)
ActivityCondition.create(activity_id: 4, condition_id: 2)
ActivityCondition.create(activity_id: 4, condition_id: 3)
ActivityCondition.create(activity_id: 4, condition_id: 4)
ActivityCondition.create(activity_id: 4, condition_id: 5)
ActivityCondition.create(activity_id: 4, condition_id: 6)
ActivityCondition.create(activity_id: 4, condition_id: 7)
