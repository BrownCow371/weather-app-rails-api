...
User.create(name: "Fred", email: "fred@rails.com", password: "password", password_confirmation: "password")
User.create(name: "George", email: "george@rails.com", password: "password", password_confirmation: "password")
User.create(name: "Linda", email: "linda@rails.com", password: "password", password_confirmation: "password")
User.create(name: "Clara", email: "clara@rails.com", password: "password", password_confirmation: "password")
User.create(name: "Bob", email: "bob@rails.com", password: "password", password_confirmation: "password")
